...
Start-Process -FilePath 'py.exe' -ArgumentList '-3','-m','uvicorn','server:app','--host','0.0.0.0','--port','8000','--reload' -WorkingDirectory $scriptDir -RedirectStandardOutput $out -RedirectStandardError $err -WindowStyle Normal
